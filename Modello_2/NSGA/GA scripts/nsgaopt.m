...
... % Optimization model
    ...
    'maxGen', 4,...           % maximum generation
    'numVar', 15,...             % number of design variables
    'numObj', 2,...             % number of objectives
    'numCons', 5,...            % number of constraints
...
... % Genetic algorithm operators
    'crossover', {{'intermediate', 0.5}},...         % crossover operator (Ratio=1.2)
    'mutation', {{'gaussian',0.6, 0.5}},...          % mutation operator (scale=0.1, shrink=0.5)
