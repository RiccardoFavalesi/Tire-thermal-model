...
%     x(ii).c_AT      = indi(ii).var(15);
    x(ii).exponentialcoefficient_Fz = indi(ii).var(1);
    x(ii).exponentialcoefficient_p = indi(ii).var(2);
    x(ii).a_coeff = indi(ii).var(3);
    x(ii).H_tread_road = indi(ii).var(4);
    x(ii).H_ta_proportional = indi(ii).var(5);
    x(ii).H_ta_constant = indi(ii).var(6);
    x(ii).b_coeff = indi(ii).var(7);
